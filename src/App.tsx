      ...
      <div className="w-full max-w-[420px] relative">
        <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[24px] p-10 shadow-2xl transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.15)] relative overflow-hidden">
          <div className="text-center mb-8">
             ...
             <p className="text-white/80 text-base">Inicia sesión en tu cuenta</p>
          </div>
          
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div className="relative">
              <input type="email" id="email" required className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-4 text-white text-base outline-none focus:border-cyan-500 focus:bg-white/15 transition-all" placeholder=" " />
              <label htmlFor="email" className="absolute left-4 top-4 text-white/70 pointer-events-none transition-all duration-300 peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-5 peer-focus:scale-75">Correo Electrónico</label>
            </div>

            <div className="relative">
              <input type="password" id="password" required className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-4 text-white text-base outline-none focus:border-cyan-500 focus:bg-white/15 transition-all" placeholder=" " />
              <label htmlFor="password" className="absolute left-4 top-4 text-white/70 pointer-events-none transition-all duration-300">Contraseña</label>
            </div>

            <button type="submit" className="w-full bg-gradient-to-r from-indigo-600 to-cyan-500 py-4 rounded-xl text-white font-semibold text-lg shadow-[0_4px_15px_rgba(99,102,241,0.4)] hover:shadow-[0_8px_25px_rgba(99,102,241,0.6)] transition-all transform hover:-translate-y-0.5">
               Iniciar Sesión
            </button>
          </form>

          <div className="my-6 flex items-center justify-center gap-4 text-white/70 text-sm">
          ...
          <button 
            onClick={login}
            className="w-full bg-white/10 border border-white/20 rounded-xl py-3 text-white font-medium flex items-center justify-center gap-3 hover:bg-white/20 transition-all transform hover:-translate-y-0.5"
          >
