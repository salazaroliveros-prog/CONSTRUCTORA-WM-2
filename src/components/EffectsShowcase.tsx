  ...
  return (
    <div className="p-6 space-y-8">
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-black text-[var(--color-primary)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="glass-card p-6 kpi-particles">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg text-[var(--color-primary)]">Efectos de Partículas</h3>
        ...
        <div className="glass-card p-6 shimmer-effect">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg text-[var(--color-primary)]">Efecto Shimmer</h3>
              <p className="text-sm text-[var(--color-neutral-600)]">
        ...
        <div className="glass-card p-6 highlight-glow">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg text-[var(--color-primary)]">Efecto Glow</h3>
              <p className="text-sm text-[var(--color-neutral-600)]">
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg text-[var(--color-primary)]">Tarjeta Interactiva</h3>
              <p className="text-sm text-[var(--color-neutral-600)]">
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg text-[var(--color-primary)]">Borde Gradiente</h3>
              <p className="text-sm text-[var(--color-neutral-600)]">
        ...
        <div className="glass-card p-6 particle-effect shimmer-effect">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg text-[var(--color-primary)]">Efectos Combinados</h3>
              <p className="text-sm text-[var(--color-neutral-600)]">
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-[var(--color-primary)]">Badges Mejorados</h2>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-[var(--color-primary)]">Botones Mejorados</h2>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-[var(--color-primary)]">Indicadores de Estado</h2>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-[var(--color-primary)]">Estados de Carga</h2>
        <div className="flex items-center gap-4">
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-[var(--color-primary)]">Skeleton Loader Avanzado</h2>
        <div className="space-y-3">
