...
const createPurchaseOrder = async () => {
  ...
  return (
    <div id="warehouse-management" className="space-y-6 animate-in fade-in duration-500 pb-[calc(4rem+env(safe-area-inset-bottom,0))] scroll-mb-[calc(4rem+env(safe-area-inset-bottom,0))]">
      ...
      <div className={cn(
        ...
        <div className="grid grid-cols-12 gap-6 items-center">
          <div className="col-span-7 bg-white/40 backdrop-blur-sm rounded-xl p-4 border border-slate-100 flex items-center justify-center min-h-50">
            <div className="relative w-full max-w-100 aspect-video grid grid-cols-4 grid-rows-2 gap-2">
              {zones.map((zone, idx) => (
                <motion.div 
                  key={zone.id}
            ...
            <tbody className="divide-y divide-slate-50">
              ...
              />
                  ...
                  <td className="hidden lg:table-cell px-4 py-2.5">
                    <span className="text-[8px] font-bold text-slate-500 truncate max-w-30 block">{item.itemName || '—'}</span>
                  </td>
                  <td className="px-4 py-2.5">
                  ...
                  <td className="hidden lg:table-cell px-4 py-2.5">
                    {editingCell?.id === item.id && editingCell.field === 'location' ? (
                      ...
                      <span
                        className="text-[8px] font-bold uppercase text-slate-500 truncate max-w-25 cursor-text"
                  ...
                  <td className="px-4 py-2.5 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button 
                        ...
                        className="btn-delete hover:bg-(--color-error-bg) rounded-lg transition-all opacity-0 group-hover:opacity-100"
                      >
                        <Trash2 size={14} />
                      </button>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <textarea value={movementForm.description} onChange={(e) => setMovementForm({ ...movementForm, description: e.target.value })} placeholder="Detalles del movimiento..." className="textarea min-h-15" />
                </div>
