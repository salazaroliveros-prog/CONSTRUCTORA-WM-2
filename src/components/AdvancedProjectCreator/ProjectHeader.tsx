      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 text-[9px] border border-white/30 rounded-xl bg-white/60 backdrop-blur-sm focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary/20"
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 text-[9px] border border-white/30 rounded-xl bg-white/60 backdrop-blur-sm focus:outline-none focus:border-secondary"
          >
            {MARKET_LEVELS.map(m => (
