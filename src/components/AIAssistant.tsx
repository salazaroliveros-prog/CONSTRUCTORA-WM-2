      ...
      <div className="shrink-0 px-6 pt-6 pb-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-black text-primary uppercase tracking-tight">Asistente IA</h2>
      ...
      <div className="flex-1 overflow-y-auto px-6 space-y-4 pb-4">
        {messages.length === 0 ? (
          <div className="space-y-6 py-4">
            ...
            <div>
              <p className="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-3">Sugerencias rápidas</p>
