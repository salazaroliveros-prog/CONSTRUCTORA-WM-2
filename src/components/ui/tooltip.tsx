    ...
    >
      ...
      {show && (
        <div
          ref={tooltipRef}
          className={cn(
            "absolute z-50 px-2.5 py-1.5 text-[10px] font-bold text-(--color-neutral-50) uppercase tracking-wider bg-(--color-neutral-900) rounded-lg whitespace-nowrap",
        ...
        >
          ...
          <div
            className={cn(
              "absolute w-2 h-2 bg-(--color-neutral-900) rotate-45",
              arrowStyles[side]
            )}
          />
        </div>
