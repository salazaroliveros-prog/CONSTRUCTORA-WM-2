  ...
  ({ className, label, error, required, ...props }, ref) => (
    <div className="space-y-1">
      ...
      <select
        ref={ref}
        className={cn(
          "w-full bg-(--color-surface-solid) border border-(--color-border) rounded-(--radius-lg) px-4 py-2.5 text-sm font-medium text-neutral-800",
          ...
          "outline-none transition-all duration-200 focus:border-secondary focus:ring-2 focus:ring-[color-mix(in_srgb,varsecondary_10%,transparent)]",
