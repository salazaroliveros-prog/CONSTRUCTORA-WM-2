...
// ── KPIs financieros y operativos mejorados ────────────────────────────────────────────────────────
  ...
  return (
    <div className="flex flex-col h-full gap-3 p-3 pb-[calc(4rem+env(safe-area-inset-bottom,0))] scroll-mb-[calc(4rem+env(safe-area-inset-bottom,0))] overflow-x-hidden">
      {/* Header */}
              ...
              <tbody>
                {[
                  ...
                  },
                  {
                    ...
                    icon: <Truck size={12} className="text-(--color-secondary-dark)" />
                  },
                  {
                    module: 'Inventario',
